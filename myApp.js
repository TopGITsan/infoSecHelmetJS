...
app.use(helmet.hidePoweredBy({setTo: 'Python 3.7.1'}));
...
app.use(helmet.hsts({
  ...
  force: true  // HyperDev already has **hsts** enabled, to override its settings you need to 
  // set the field `force` to `true` in the config object.
}));
